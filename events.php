  ...
  <div class = "container">
    <div class = "container-text">
      ...
      <div class = "content-block">
        ...
        <div class = "content-flex">
          <div class = "content-flex-image">
            <!-- Image source: https://docs.google.com/presentation/d/1GE6zBdo31--hT8sd-EQjGszfoA3S6dXW5IPSkJ4MXXI/edit#slide=id.g255079f6af_0_0-->
      ...
      <div class = "content-block">
        ...
        <div class = "content-flex">
          <div class = "content-flex-image">
            <!-- <img class="image" id="events-credit"  src="images/credit.png" alt = "events-credit"> -->
            <img class="image" id="events-blackrock"  src="images/blackrock.png" alt = "events-blackrock">
          </div>
          <div class = "content-flex-text">
            <p class="speakers1">SBA values the experience of today’s industry leaders. We invite
              representatives from companies such as Credit Suisse,
               Guest speakers give students a more dimensional
              perspective on sustainable business and its functions today. Guest
              Speaker from Black Rock will be able to provide information
              on the corporate financila sustainability and how that can be
              improved so that business start taking a more active role in the
              enviornment</p>
            </div>
        </div>
      </div>
        ...
        <div class = "content-flex">
          ...
          <div class = "content-flex-text">
            <p>A primary goal of SBA is to provide the means for our members to
             ...
             other club members in the context of entering the industry. We achieve this through
             private networking events where members not only build connections, but practice and
             develop the networking skills necessary to succeed in business.</p>
